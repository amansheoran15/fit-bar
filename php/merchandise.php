...
// ini_set('error_reporting', E_ALL );
    ...
    if(isset($_SESSION['pu'])){
        ...
        <strong>Hey!</strong> Password Updated Successfully.Now you can login.
    ...
    if(isset($_POST['add'])){
       ...
       if(isset($_SESSION['cart'])){
        ...
        $sqlx="SELECT * FROM `cart` WHERE `username`='$uname' AND `prod_id`='$idd' AND `size`='$sizee'";
        ...
        if($numx>0){
            ...
            if($idd==1 || $idd==2){
                ...
                $sqlz = "INSERT INTO `cart` (`username`, `prod_id`, `quantity`,`size`) VALUES ('$uname', '$idd', '1','$size');";
